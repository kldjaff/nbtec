...
?>
        ...
        <?php
            ...
            $ui['has'] =$ui_compile->list_page_config($met_page);
            ?>
<div class="news_list_met_16_5_50 met-index-body" data-original='<?php echo $ui['home_copy_bg'];?>' m-id='<?php echo $ui['mid'];?>'>
    <div class="container">
...
?>
        ...
        <?php
            ...
            $ui['has'] =$ui_compile->list_page_config($met_page);
            ?>
<div class="partner_list_met_16_2_40 met-index-body     <?php if($ui[bg_type]){ ?>bgcolor<?php }else{ ?>bgpic<?php } ?>" m-id='<?php echo $ui['mid'];?>'>
