...
<div class="v52fmbx">
    ...
    <form method="POST" class="ui-from" name="myform" action="{$_M[url][own_form]}a=dosave" target="_self">
        ...
        <dl>
            ...
            <dd class="ftype_textarea" style="width:500px;height:120px;">
                <div class="fbox">
                    <textarea type="text" name="mobile_footer" style="width:500px;height:120px;">{$content['mobile_footer']}</textarea>
                </div>
                
            </dd>

            <dd><span style="color:red" class="tips">{$mobile_w}</span></dd>
        </dl>
        <dl>
            <dt>前台默认图片</dt>
...
-->
        ...
        <dl>
        <label style="display:opacity:0"><input name="radion" type="checkbox"   data-showhide="more">高级设置</label>
        </dl>
...
<div class="more none">
        ...
        <dl>
            ...
            <dd >
              <div class="fbox">
                 <a class="btn btn-danger btn-xs" href="{$_M['url']['site_admin']}/index.php?lang=cn&anyid=44&n=myapp&c=myapp&a=dodelapp&no=10038" onclick="if(confirm('关闭应用商店的情况下卸载此应用将导致网站无法安装新应用！')==false)return false;">确认卸载</a>
