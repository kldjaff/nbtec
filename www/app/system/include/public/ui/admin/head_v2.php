...
?>
<link href="{$_M['url']['site']}public/ui/v2/static/css/basic_admin.css?{$basic_admin_css_filemtime}" rel='stylesheet' type='text/css'>
<?php
}
            ...
            <div class="vertical-align-middle">
                ...
                <div class="btn-group" {$met_agents_metmsg}>
                    <button class="btn btn-default" data-toggle="modal" data-target="#functionEncy">
                        ...
                        <span class="hidden-sm-down">{$_M['word']['funcCollection']}</span>
                    </button>
                </div>
                <?php } ?>
                <div class="btn-group" {$met_agents_metmsg}>
                    <a class="btn btn-default" target="_blank">
                        ...
                        <span class="hidden-sm-down">{$_M['word']['indexbbs']}</span>
                    </a>
                </div>
                <div class="btn-group" {$met_agents_metmsg}>
                    ...
                    <ul class="dropdown-menu animate animate-reverse dropdown-menu-right text-xs-center">
                        ...
                        <li class="dropdown-item">
                            <a target="_blank" class='block'>{$_M['word']['sys_authorization2']}</a>
                        </li>
                        <li class="dropdown-item">
                            <a class="btn btn-primary" href='{$_M['url']['adminurl']}&n=system&c=authcode&a=doindex'>{$_M['word']['sys_authorization1']}</a>
                        </li>
                        <?php }else{ ?>
                        <li class="dropdown-item">
                        ...
                        <li class="dropdown-item">
                            <a class="nobo block" href="{$_M['url']['adminurl']}&n=system&c=authcode&a=doindex">{$_M['word']['entry_authorization']}</a>
                        </li>
                        <?php
                            }
                        }
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu animate animate-reverse dropdown-menu-right">
                        ...
                        <?php } ?>
                        <li class="dropdown-item">
                            <a href='{$url.adminurl}anyid=10&n=language&c=language_admin&a=dolangadd' class="btn btn-success"><i class="fa fa-plus"></i>{$_M['word']['added']}{$_M['word']['langweb']}</a>
                        </li>
                    </ul>
                </div>
                <?php if(!$_M['config']['met_agents_switch']){ ?>
                <div class="btn-group">
                    <a class="btn btn-default" href='{$_M['url']['adminurl']}n=system&c=news&a=doindex'>
