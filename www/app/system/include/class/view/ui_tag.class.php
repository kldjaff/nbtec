...
<meta name="generator" content="<?php if($_GET[pageset]){ ?>MetInfo {$c.metcms_v}<?php } ?>" data-variable="{$c.met_weburl}|{$data.lang}|{$data.synchronous}|{$c.met_skin_user}|{$data.module}|{$data.classnow}|{$data.id}" data-user_name="{$user_name}">
