...
require_once $this->template('own/pageset/static/config');
$pageset_ifrane_src=$_COOKIE['page_iframe_url']?$_COOKIE['page_iframe_url']:"{$_M['url']['site']}index.php?lang={$_M['lang']}";
if(strpos($pageset_ifrane_src, 'pageset=1')==false){
	if(strpos($pageset_ifrane_src, '?')!=false){
		$pageset_ifrane_src.='&pageset=1';
	}else{
		$pageset_ifrane_src.='?pageset=1';
	}
}
...
<meta name="generator" content="MetInfo {$_M['config']['metcms_v']}" data-variable="{$_M['config']['met_weburl']}|{$_M['lang']}||||pageset" />
...
<header class='header h-50 bg-blue-grey-800 white page-head'>
			...
			<div class="row">
				<div class='vertical-align h-50'>
					<div class='vertical-align-middle w-full page-head-nav'>
		                ...
		                <div class="collapse navbar-collapse navbar-collapse-toolbar p-0" id="page-nav-collapse">
							...
							<div class="btn-group m-l-10">
								...
								<ul class="dropdown-menu m-t-10" role="menu" aria-labelledby="adminuser">
									...
									<a href="javascript:;" class='dropdown-item nav-tem-choose' data-url='{$_M['url']['adminurl']}anyid=18&n=theme&c=theme&a=doindex' title='{$_M[word][templates_choice]}'>{$_M[word][templates_choice]}</a>
									<a href="javascript:;" class='dropdown-item' data-url='{$_M['url']['adminurl']}anyid=11&n=imgmanager&c=imgmanager&a=dowatermark' title='{$_M[word][watermarkThumbnail]}'>{$_M[word][watermarkThumbnail]}</a>
...
-->
							...
							<div class="btn-group m-l-10">
								...
								<ul class="dropdown-menu m-t-10" role="menu" aria-labelledby="adminuser">
									...
									<a href="javascript:;" class='dropdown-item' data-url='{$_M['url']['adminurl']}anyid=65&n=appstore&c=appstore&a=doindex' title='{$_M[word][metShop]}' {$met_agents_app}>{$_M[word][metShop]}</a>
							...
							<div class="pull-xs-right">
								<div class="btn-group m-l-10">
									...
									<ul class="dropdown-menu dropdown-menu-right m-t-10" role="menu" aria-labelledby="adminuser">
										...
										<a href="javascript:;" class='dropdown-item' data-toggle="modal" data-target=".pageset-nav-modal" title='{$_M[word][navSetting]}'>{$_M[word][navSetting]}</a>
<!--
EOT;
...
-->	
								...
								<div class="btn-group m-l-10">
									<button class="btn btn-dark btn-outline white dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="true">{$power['admin_id']}</button>
									<ul class="dropdown-menu dropdown-menu-right m-t-10" role="menu" aria-labelledby="adminuser">
...
<div class="text-xs-center m-b-0 bg-blue-grey-100 alert pageset-tips">
    ...
    <div>
        <button type='button' class="btn btn-default" id='no-prompt' data-url="{$_M['url']['adminurl']}anyid=&n=index&c=index&a=do_no_prompt" data-dismiss="alert">{$_M[word][nohint]}</button>
...
echo <<<EOT
-->
<iframe src="{$pageset_ifrane_src}" id='page-iframe' frameborder="0" width="100%"></iframe>
<div class="modal fade modal-primary blockset-modal" id="blockset-modal" aria-hidden="true" aria-labelledby="blockset-modal" role="dialog" tabindex="-1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content h-100p">
			...
			<div class="modal-body">
				...
				<iframe data-src='{$_M['url']['own_form']}a=doset_area' id='blockset-iframe' class='h-100p' frameborder="0" width="100%"></iframe>
			</div>
...
<div class="modal fade modal-primary content-modal" id="content-modal" aria-hidden="true" aria-labelledby="content-modal" role="dialog" tabindex="-1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content h-100p">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			...
			<div class="modal-body">
				<iframe data-src='{$_M['url']['own_form']}a=doset_content' id='content-iframe' class='h-100p' frameborder="0" width="100%"></iframe>
			</div>
		</div>
	</div>
</div>
<div class="modal fade modal-primary ueeditor-modal" id="ueeditor-modal" aria-hidden="true" aria-labelledby="ueeditor-modal" role="dialog" tabindex="-1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content h-100p">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal fade modal-primary img-modal" id="content-modal" aria-hidden="true" aria-labelledby="content-modal" role="dialog" tabindex="-1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content h-100p">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			...
			<div class="modal-body">
				...
				<iframe data-src='{$_M['url']['own_form']}a=doset_img' id='img-iframe' class='h-500' frameborder="0" width="100%"></iframe>
			</div>
			<div class="modal-footer p-t-0">
				<button type="button" class="btn btn-default" data-dismiss="modal">{$_M['word']['indexonlieno']}</button>
				<button type="submit" class="btn btn-primary">{$_M['word']['Submit']}</button>
...
<div class="modal fade modal-primary nav-modal" id="nav-modal" aria-hidden="true" aria-labelledby="nav-modal" role="dialog" tabindex="-1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content h-100p">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal fade modal-primary config-modal" id="config-modal" aria-hidden="true" aria-labelledby="config-modal" role="dialog" tabindex="-1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<iframe id='config-index-iframe' class='h-500 config-iframe' frameborder="0" width="100%"></iframe>
				<iframe id='config-page-iframe' class='h-500 config-iframe' frameborder="0" width="100%"></iframe>
				<iframe id='config-public-iframe' class='h-500 config-iframe' frameborder="0" width="100%"></iframe>
			</div>
			<div class="modal-footer p-t-0">
				<button type="button" class="btn btn-default" data-dismiss="modal">{$_M['word']['indexonlieno']}</button>
				<button type="submit" class="btn btn-primary">{$_M['word']['Submit']}</button>
...
<div class="modal fade modal-primary pageset-nav-modal" id="pageset-nav-modal" aria-hidden="true" aria-labelledby="pageset-nav-modal" role="dialog" tabindex="-1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content h-100p">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				...
				<h4 class="modal-title">{$_M[word][navSetting]}</h4>
			</div>
			<div class="modal-body">
				<iframe data-src='{$_M['url']['own_form']}a=doset_pageset_nav' id='pageset-nav-iframe' class='h-100p' frameborder="0" width="100%"></iframe>
			</div>
			<div class="modal-footer p-t-0">
				<button type="button" class="btn btn-default" data-dismiss="modal">{$_M['word']['indexonlieno']}</button>
				<button type="submit" class="btn btn-primary">{$_M['word']['Submit']}</button>
...
<div class="modal fade modal-primary functionEncy-modal" id="functionEncy-modal" aria-hidden="true" aria-labelledby="functionEncy-modal" role="dialog" tabindex="-1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content h-100p">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			...
			<div class="modal-body">
				<iframe data-src='{$_M['url']['own_form']}a=dofunction_ency' id='functionEncy-iframe' class='h-100p' frameborder="0" width="100%"></iframe>
			</div>
		</div>
	</div>
</div>
