...
<body class="met-navfixed <if value="($data[classnow] neq 10001 && !$ui[opcity])|| !$sub">ny-nobanner <else/>ny-banner </if>">
</if>
<if value="$ui['navfixed_ok']">
...
<header class='met-head' m-id='{$ui.mid}' m-type='head_nav'>
    ...
    <nav class="navbar navbar-default box-shadow-none $uicss <if value="$ui['navbgok']"> bgcolor</if>">
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-header pull-xs-left">
                    <a href="{$c.index_url}" class="met-logo vertical-align block pull-xs-left p-y-5" title="{$c.met_webname}">
                        <div class="vertical-align-middle">
                            ...
                            <else/>
                                <img src="{$c.met_logo}" alt="{$c.met_webname}" class="logo addhide">
                                <img src="{$ui.logo}" alt="{$c.met_webname}" class="logo1 hidden">
                            </if>
                        </div>
                    </a>
                    ...
                    <ul class="nav navbar-nav navlist">
                        ...
                        <li class="nav-item dropdown m-l-{$ui.nav_ml}">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animate two-menu">
                                ...
                                <if value="($m[module] neq 1  || $m[isshow]) && $m[url]">
