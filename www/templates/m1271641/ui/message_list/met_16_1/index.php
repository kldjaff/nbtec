...
<?php $sidebar=strlen($ui[has][message_form]);?>
<tag action='message.list' num="$c['met_message_list']"></tag>
<if value='$sub'>
<section class="$uicss animsition"  m-id='{$ui.mid}' m-type='nocontent'>
    <div class="container">
        <div class="row m0">
<div class="<if value='!$sidebar'>col-md-10 offset-md-1<else/>col-md-8</if>  met-message-body panel panel-body m-b-0" boxmh-mh m-id='noset' m-type='message_list'>
<div class="row m0">
