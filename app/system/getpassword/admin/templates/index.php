...
EOT;
    ...
    echo <<<EOT
    <a style="font-size:0px;" target="_blank" title="{$_M[word][metinfo]}">
EOT;
}
echo <<<EOT
	<!--<a  style="font-size:0px;" target="_blank" title="{$_M[word][metinfo]}">-->
...
-->
		...
		<span class="abt_tt">{$_M[word][password27]}</span><br/><span class="abt_dis"><a target="_blank">{$_M[word][password28]}</a></span>
		</label></p>
<!--
EOT;
}
